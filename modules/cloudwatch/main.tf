...
resource "aws_cloudwatch_metric_alarm" "http_400_error_alarm" {
...
# COMMENTED OUT: Instance-specific monitoring (for Auto Scaling compatibility)
# These alarms are designed for single instances, but Auto Scaling handles this differently
# The Auto Scaling module already has CPU-based scaling policies

# ORIGINAL: monitors the instance for network bandwidth usage less than 300 mbps
...
# ORIGINAL: monitors the instance for network bandwidth usage more than 750 mbps
...
# ORIGINAL: monitors for high cpu usage of the instance
...
# ORIGINAL: monitors for low cpu usage of the instance
